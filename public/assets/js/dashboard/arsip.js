...
$(document).ready(function () {
    ...
    const arsipDatatable = $('#arsip-datatable');

    const datatable = arsipDatatable.DataTable({
        serverSide: true,
        processing: true,
        autoWidth: false,
        ajax: {
            url: arsipDatatable.attr('data-url'),
            data: function(d) {
        ...
        columns: [
            ...
            { data: 'Nama Pemohon', name: 'Nama Pemohon', searchable: true },
            { data: 'Tanggal Pengurusan', name: 'Tanggal Pengurusan', searchable: true, className: 'white-space' },
            { data: 'Tanggal Arsip', name: 'Tanggal Arsip', searchable: false },
            { data: 'Ruangan', name: 'Ruangan', searchable: false },
            { data: 'Lemari', name: 'Lemari', searchable: false },
            { data: 'Rak', name: 'Rak', searchable: false },
            { data: 'Laci', name: 'Laci', searchable: false },
            { data: 'Box', name: 'Box', searchable: false },
