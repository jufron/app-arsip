<x-layouts.dashboard.app title="Ubah Data Petugas">
    {{-- * my style --}}
    <x-slot:myStyle>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-dashboard.input-select label="Jenis Pengurusan" name="jenis_pengurusan">
                            @foreach ($jenis_pengurusan as $value )
                                <option
                                    value="{{ $value }}"
                                    @if($pemohon->jenis_pengurusan === $value) selected @endif
                                    >{{ $value }}
                                </option>
                            @endforeach
                    ...
                    <div class="col-md-4">
                        <x-dashboard.input
                            ...
                            type="date"
                            value="{{ old('tanggal_pengurusan', $pemohon->tanggal_pengurusan) }}"
